...
with DAG(
    ...
    catchup=False,
    tags=["ODS", "cars"],
    description="STG -> ODS (cars) SCD2 merge",
) as dag:

    wait_stg = ExternalTaskSensor(
        task_id="wait_stg_cars_loaded",
        external_dag_id="daily_amocrm_load_cars",
        external_task_id="load_cars_to_pg",
